...
def test_init(lawn_grass):
    ...
    assert lawn_grass.__repr__() == ('Создан объект со свойствами name: Стандартный,description: Умеренное '
                                     'устойчивость к механическим нагрузкам,_Product__price: 175.0,quantity: 1000,'
                                     'color: привлекательный ярко-зеленый,manuf_country: Russia,germ_period: 24,)')
