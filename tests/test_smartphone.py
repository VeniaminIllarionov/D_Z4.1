...
def test_init(smartphone):
    ...
    assert smartphone.__repr__() == ("SmartPhone(dict_items([('name', 'Samsung'), ('description', '200MP камера'), "
                                     "('_Product__price', 180000.0), ('quantity', 10), ('color', 'Серый цвет'), "
                                     "('performance', 24), ('model', 'Galaxy C23 Ultra'), ('amount_memory', "
                                     '256)]))')
